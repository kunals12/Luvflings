...
-- AlterTable
ALTER TABLE "Matches" ALTER COLUMN "userId" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "Story" ALTER COLUMN "userId" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "StoryReaction" ALTER COLUMN "userId" SET DATA TYPE BIGINT;
...
-- AlterTable
ALTER TABLE "UserResponse" ALTER COLUMN "userId" SET DATA TYPE BIGINT;
